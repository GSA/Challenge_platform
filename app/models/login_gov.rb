...
class LoginGov
  ...
  def exchange_token_from_auth_result(code_param)
    ...
    openid_config = well_known_configuration
    ...
    jwt_assertion = JWT.encode(assertion_claims, private_key, 'RS256')
    ...
    JWT.decode(id_token, nil, true, algorithms: ["RS256"], jwks:)
  end
