...
RSpec.describe "Export Submissions", type: :system do
  ...
  it "shows alert when no export options are selected", js: true do
  ...
  it "successfully exports submissions CSV", js: true do
    find("[data-action='click->export-submissions#open']").click
  ...
  it "successfully exports evaluations CSV", js: true do
    find("[data-action='click->export-submissions#open']").click
  ...
  it "successfully exports both submissions and evaluations CSV", js: true do
    find("[data-action='click->export-submissions#open']").click
