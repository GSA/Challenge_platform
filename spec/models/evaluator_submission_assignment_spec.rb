...
RSpec.describe EvaluatorSubmissionAssignment, type: :model do
  ...
  it "can be destroyed" do
    assignment = create(:evaluator_submission_assignment, submission: submission, evaluator: user)
    expect { assignment.destroy }.to change(EvaluatorSubmissionAssignment, :count).by(-1)
  end

  it "associates the user as an evaluator for the submission" do
    create(:evaluator_submission_assignment, submission: submission, evaluator: user)
