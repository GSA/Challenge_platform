...
You must get the `vars.challenge-proxy.yml` file from a developer on the team for the current username and password values and the list of allowed connections.

```
proxyname:  challenge-proxy
